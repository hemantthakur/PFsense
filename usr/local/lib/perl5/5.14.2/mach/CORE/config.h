...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Tue Apr 30 16:56:56 UTC 2013
 * Configured by     : root
 * Target system     : freebsd 81amd64-default-job-07 8.1-release freebsd 8.1-release amd64 
 */
 ...
 */
#define ARCHLIB "/usr/local/lib/perl5/5.14.2/mach"		/**/
#define ARCHLIB_EXP "/usr/local/lib/perl5/5.14.2/mach"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl5/site_perl/5.14.2/mach"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl5/site_perl/5.14.2/mach"		/**/
